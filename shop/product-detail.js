            ...
            <div class="md:flex-1 px-4">
              ...
              <div class="mb-4">
                ...
                ${productData.colors.map((color) => `
                    <button class="w-6 h-6 border border-gray-800 rounded-full mr-2 clr-btns" style="background-color: ${color};" data-val-color="${color}"></button>
                `).join("")}
                </div>
            </div>` : ""}
            ${productData?.sizes ? `
            <div class="mb-4">
                ...
                <div class="flex items-center mt-2">
                    ${productData.sizes.map((size) => `
                            <button class="bg-gray-300 text-gray-700 py-2 px-4 rounded-full font-bold mr-2 hover:bg-gray-400 size-btns">${size}</button>
                        `).join("")}
                </div>
            </div>
        `: ""}
